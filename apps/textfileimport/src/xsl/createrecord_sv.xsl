...
<xsl:template match="container">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="1024px" class="main">
			<tr>
				<th class="field1">Nyckel</th>
				<th class="field2">Fält från Lime</th>
				<th class="field3">Fält från importfil</th>
			</tr>
...
<xsl:template match="fileoptions">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" class="sub">
			<th class="subheaderTable field1sub">Värde i Lime</th>
			<th class="subheaderTable field2sub">Värde i fil</th>
			<xsl:apply-templates>
...
<xsl:template match="limeoptions">
		<br/>
		<table cellpadding="0" cellspacing="0" border="0" width="100%" class="sub">
			<th class="subheaderTable">Slumpas ut mellan</th>
			<xsl:apply-templates>
